...
<div class="container mt-5">
        ...
        <form method="GET" class="d-flex mb-3">
            ...
            <input type="text" name="set_search" class="form-control" placeholder="Search game sets" value="<?= isset($_GET['set_search']) ? htmlspecialchars($_GET['set_search']) : '' ?>">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Delete Buttons -->
                        <button class="btn btn-danger" onclick="deleteSet(<?= $row['id'] ?>, <?= $game_id ?>)">Delete</button>
                    </td>
                </tr>
                <?php endwhile; ?>
                <?php else: ?>
