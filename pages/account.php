<?php
    ...
    include '../includes/accountService.php';   
?>
...
<div id="content">
    <div class="container mt-5">
        ...
        <div class="card-body">
            ...
            <!-- Form that ill allow the user to change userName or password -->
            <form method="post" action="account.php">
                <div class="mb-3">
                    <label for="username">Username</label>
                    <input class="form-control" id="username" type="email" name="username"
                        value="<?php echo htmlspecialchars($_SESSION['username']); ?>" disabled required>
                </div>
